                            ...
                            <div id="formulario">
                                <div class="campo-top">
                                    ...
                                    <input type="tel" name="id" id="id" oninput="mascaraId(this)" onpaste="return false"
                                        ondrop="return false" onclick="controlaFalhasInputId()" value="<%=id%>"
                                        required>
                                ...
                                <div class="forms-brutos">
                                    ...
                                    <input class="input-dado" name="compras" type="number" min="0" max="999999" step="1"
                                        id="lb3" required disabled>
                                </div>
                                <div class="forms-brutos">
