...
function adcionarBotao() {
  ...
  buscar.setAttribute("style", "display: none !important;");
  adcionar.setAttribute("style", "display: none !important;");
  salvar.setAttribute("style", "display: block !important;");
  cancelar.setAttribute("style", "display: block !important;");
  if (document.body.clientWidth > 992) {
    labelid.setAttribute("style", "width: 360px;");
    entradaId.setAttribute("style", "margin-left: 10px; width: 360px;");
  }
