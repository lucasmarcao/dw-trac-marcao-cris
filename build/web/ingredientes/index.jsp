  ...
  <div class="crud">
    <form method="post" autocomplete="off" class="cabeca" id="form">
      ...
      <div class="corpo container">
        <div class="linha row">
          <div class="col-6 label-dado">Nome Ingrediente</div>
          <input type="text" name="lb1" class="col-6 input-dado" id="lb1" minlength="2" maxlength="24" required
            disabled>
        </div>
        <div class="linha row">
          <div class="col-6 label-dado">ID FORNECEDOR</div>
          <select type="text" name="lb2" class="col-6 input-dado" id="lb2" required disabled>
            <option value="1"> 1 - Sadia </option>
            <option value="2">2 - friboi </option>
          </select>
        </div>
      </div>
    </form>
