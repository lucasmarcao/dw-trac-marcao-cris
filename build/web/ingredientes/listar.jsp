            ...
            <div class="caixa-lista">
              <div class="modal-conteudo">
                <div class="modal-header titulo-modal">
                  <h5 class="modal-titulo" id="staticBackdropLabel">Listando os Ingredientes</h5>
                  ...
                  <div class="demo">
                    <div class="scroll" id="corpo-lista">
                      <div class="cabeca-modal">
                        ...
                        <div class="cabeca-item list-maior">
                          <h4> FORNECEDOR
                          </h4>
                        </div>
                      </div>
                      <div class="itens">
                        <div class="id-item dado-item">1</div>
                        <div class="dado-item">Calabresa</div>
                        <div class="dado-item list-maior">1 - Friboi</div>
                      </div>
                      <div class="itens">
                        <div class="id-item dado-item">2</div>
                        <div class="dado-item">Farinha</div>
                        <div class="dado-item list-maior">4 - Pinduca</div>
                      </div>
                      <div class="itens">
                        <div class="id-item dado-item">1</div>
                        <div class="dado-item">Calabresa</div>
