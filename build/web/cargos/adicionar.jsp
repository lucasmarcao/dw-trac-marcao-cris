      ...
      <form action="/dw2-marcao-cristofer/CargosServlet" method="post" autocomplete="off">
        ...
        <div class="centro master">
          ...
          <div id="formulario">
            ...
            <div class="forms-brutos">
              ...
              <input class="input-dado" name="nome" type="text" minlength="3" maxlength="25" id="lb1" required disabled>
            </div>
            <div class="forms-brutos">
              <button type="button" class="lb-defalt lb-area">DESCRIÇÃO CARGO</button>
              <textarea class="input-dado txt-area" name="descricao" type="text" minlength="3" maxlength="100" id="lb2" required disabled>
              </textarea>
            </div>
          </div>
        ...
        <div class="centro">
          <div class="conteudo-extra">
            <div class="flex">
              <a class="botao-baixo-crud adcionar" id="adcionar" onclick="adcionarBotao()">
                adcionar
              </a>
            </div>
            <div class="flex">
