...
<body class="scroll">
  ...
  <div class="centro master">
    ...
    <form action="/dw2-marcao-cristofer/AcompanhamentosServlet" id="formulario" method="post" autocomplete="off">
      <div class="campo-top">
      ...
      <div class="forms-brutos">
       ...
       <input class="input-dado" name="" type="text" minlength="3" maxlength="25" id="lb2" required disabled>
      </div>
    </form>
