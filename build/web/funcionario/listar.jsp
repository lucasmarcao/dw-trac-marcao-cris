<%@page import="static Entidades.Access.$Funcionario" %>
                            ...
                            <div class="caixa-lista">
                                <div class="modal-conteudo">
                                    <div class="modal-header titulo-modal">
                                        <h5 class="modal-titulo" id="staticBackdropLabel">Listando os Funcionarios</h5>
                                        <a href="index.jsp" id="fechalista" class="close" data-dismiss="modal"
                                           aria-label="Close">
                                    ...
                                    <div class="modal-corpo corpo-modal">
                                        <div class="demo">
                                            <div class="scroll" id="corpo-lista">
                                                ...
                                                <%for (Funcionario funcionario : $Funcionario.result("all")) {%>
                                                <div class="itens">
                                                    ...
                                                    <div class="dado-item" 
                                                         style="width: 220px !important; height: 100px;">
                                                        <%=funcionario.getPessoaidpessoa()%>                                                        
                                                    </div>
                                                    <div class="dado-item" 
                                                         style="width: 220px !important; height: 100px;">
                                                        <%=funcionario.getCargosidcargos()%>                                                        
                                                    </div>
                                                </div>
                                                <%}%>
                                            </div>
