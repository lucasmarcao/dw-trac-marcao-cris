  ...
  <div class="centro">
    <main class="centro">
      <div class="card text-center fundo-azul">
        ...
        <div class="card-body">
          <h5 class="card-title">Faça o teu Cadastro</h5>
          <form action="" class="container">
            <div class="row">
              <input style="height: 40px;" id="nomeuser" class="col-12" type="text" placeholder="Nome de Usuário" minlength="2"
                required>
            </div>
            <hr>
            <div class="row">
              <input style="height: 40px;" id="emailuser" class="col-12" type="email" placeholder="Seu Email" minlength="3" required>
            </div>
            <hr>
            <div class="row">
              <input style="height: 40px;" id="senhauser" class="col-12" type="password" placeholder="Senha" minlength="3" required>
            </div>
            <hr>
            <button type="button" id="botaologar" class="btn btn-primary" style="width: 200px;"> Entrar </button>
          </form>
        </div>
      </div>
    </main>
