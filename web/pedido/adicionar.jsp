                        ...
                        <div class="crud">
                            <form method="post" autocomplete="off" class="cabeca" id="form">
                                ...
                                <input type="tel" class="campo input" name="id" id="id" oninput="mascaraId(this)"
                                    onpaste="return false" ondrop="return false" onclick="controlaFalhasInputId()"
                                    required>
                                <div class="centraliza">
                                    <input type="hidden" value="SEARCH" id="opcao" name="function"> <button
                                        type="button" onclick="buscarBotao()" class="campo botao buscar"
                                        id="buscar">buscar</button>
                                    <button type="button" onclick="adcionarBotao()" class="campo botao adcionar"
                                        id="adcionar">adcionar</button>
                                </div>
                                <div class="centraliza">
                                    <a href="listar.jsp">
                                ...
                                <div class="centraliza">
                                    <button type="submit" onclick="salvarBotao()" class="campo botao salvar"
                                        id="salvar">salvar</button>
                                    <a href="index.jsp">
                                        <button type="button" class="campo botao cancelar"
                                ...
                                <div class="corpo container">
                                    <div class="linha row">
                                        ...
                                        <select type="text" name="lb4" class="col-6 input-dado" id="lb4" required
                                            disabled>
                                            <%for (Cliente cliente : $Cliente.result("all")) {%>
                                                <option value="<%=cliente.getIdcliente()%>">
                                                    <%=cliente.getIdcliente()%> - {<%=cliente.getPessoaidpessoa()%>}
                                                </option>
                                                <%}%>
                                        </select>
                                    </div>
                                    <div class="linha row">
                                        ...
                                        <select type="text" name="lb4" class="col-6 input-dado" id="lb4" required
                                            ...
                                            <%for (Acompanhamentos acompanhamentos : $Acompanhamentos.result("all")) {%>
                                                <option value="<%=acompanhamentos.getIdacompanhamentos()%>">
                                                    <%=acompanhamentos.getIdacompanhamentos()%> - {
                                                        <%=acompanhamentos.getNomeaconpanhamento()%>}
                                                </option>
                                                <%}%>
                                        </select>
                                    </div>
                                    <div class="linha row">
                                        ...
                                        <input type="date" name="lb3" class="col-6 input-dado" id="lb3" maxlength="20"
                                            required disabled>
                                    </div>
                                    <div class="linha row">
