<%@page contentType="text/html" pageEncoding="UTF-8" %>
  ...
  <body class="scroll">
    ...
    <div class="centro master">
      ...
      <form action="/dw2-marcao-cristofer/CargosServlet" id="formulario" method="post" autocomplete="off">
        <div class="campo-top">
          ...
          <input type="tel" name="id" id="id" oninput="mascaraId(this)" onpaste="return false" ondrop="return false"
            onclick="controlaFalhasInputId()" required>
        ...
        <div class="forms-brutos">
          ...
          <input class="input-dado" name="" type="text" minlength="3" maxlength="25" id="lb1" required disabled>
        </div>
        <div class="forms-brutos">
          <button type="button" class="lb-defalt lb-area">DESCRIÇÃO CARGO</button>
          <textarea class="input-dado txt-area" name="" type="text" minlength="3" maxlength="25" id="lb2" required disabled>
          </textarea>
        </div>
      </form>
