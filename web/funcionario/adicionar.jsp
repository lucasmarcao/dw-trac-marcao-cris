  ...
  <div class="crud">
    <form method="post" autocomplete="off" class="cabeca" id="form">
      ...
      <div class="corpo container">
        <div class="linha row">
          <div class="col-6 label-dado">SALARIO</div>
          <input type="number" name="lb1" class="col-6 input-dado" id="lb1" min="1" maxlength="24" required disabled>
        </div>
        <div class="linha row">
          <div class="col-6 label-dado">TRABALHANDO?</div>
          <div class="custom-control custom-switch col-6 input-dado centro">
            <input type="checkbox" class="custom-control-input" name="lb2" id="lb2" required>
            <label class="custom-control-label" for="lb2">Marque</label>
          </div>
        </div>
        <div class="linha row">
          <div class="col-6 label-dado">PESSOA</div>
          <select type="text" name="lb3" class="col-6 input-dado" id="lb3" required disabled>
            <option value="1"> 1 - Marcão </option>
            <option value="2">2 - Luana</option>
          </select>
        </div>
        <div class="linha row">
          <div class="col-6 label-dado">CARGOS</div>
          <select type="text" name="lb4" class="col-6 input-dado" id="lb4" required disabled>
            <option value="1">1 - Chefe </option>
            <option value="2">2 - Garçon</option>
          </select>
        </div>
      </div>
    </form>
