            ...
            <div class="caixa-lista">
              <div class="modal-conteudo">
                <div class="modal-header titulo-modal">
                  <h5 class="modal-titulo" id="staticBackdropLabel">Listando as Pizzas</h5>
                ...
                <div class="modal-corpo corpo-modal">
                  <div class="demo">
                    <div class="scroll" id="corpo-lista">
                      ...
                      <div class="itens">
                        <div class="id-item dado-item">99</div>
                        <div class="dado-item">4 Queijos</div>
                        <div class="dado-item">Salgado</div>
                        <div class="dado-item">55 R$</div>
                        <div class="dado-item">8 Pedaços</div>
                      </div>
                      <div class="itens">
                        <div class="id-item dado-item">93</div>
                        <div class="dado-item">4 Queijos</div>
                        <div class="dado-item">Salgado</div>
                        <div class="dado-item">65 R$</div>
                        <div class="dado-item">12 Pedaços</div>
                      </div>
                      <div class="itens">
                        <div class="id-item dado-item">92</div>
                        <div class="dado-item">4 Queijos</div>
                        <div class="dado-item">Salgado</div>
                        <div class="dado-item">25 R$</div>
                        <div class="dado-item">4 Pedaços</div>
                      </div>
                    </div>
