                            ...
                            <div class="caixa-lista">
                                <div class="modal-conteudo">
                                    <div class="modal-header titulo-modal">
                                        <h5 class="modal-titulo" id="staticBackdropLabel">Listando os Acompanhamentos</h5>
                                            ...
                                            <div class="scroll" id="corpo-lista">
                                                ...
                                                <div class="itens">
                                                    <div class="id-item dado-item" 
                                                         style="width: 220px !important; height: 100px !important;">
                                                    ...
                                                    <div class="dado-item" 
                                                         style="width: 220px !important; height: 100px !important;">
                                                        <%=acompanhamentos.getFornecedoridfornecedor()%>                                                        
                                                    </div>
                                                </div>
                                                <%}%>
                                            </div>
